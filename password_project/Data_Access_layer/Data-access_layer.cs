...
using System.Data;
namespace password_project.Data_Access_layer
{
    class Data_access_layer{ 
         SqlConnection cn ;
        public Data_access_layer()
        {
            cn = new SqlConnection(@"Data Source=USERFILES\SQLEXPRESS;Initial Catalog=Passwords_project;Integrated Security=True");
        }
